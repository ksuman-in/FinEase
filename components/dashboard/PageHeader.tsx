...
export default async function PageHeader({ action = "" }: { action?: string }) {
  ...
  return (
    <header className="sticky top-4 mx-4 md:mx-8 glass-morphism rounded-[2rem] border border-white shadow-sm px-4 md:px-8 py-3 transition-all duration-300 z-20">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 pl-4 border-l border-white/40">
            ...
            <div
              className="w-10 h-10 flex justify-center items-center rounded-2xl bg-slate-900 text-white shadow-lg shadow-slate-900/20 hover:scale-105 transition-transform cursor-pointer border border-white/10"
